...
{
    public class OutgoListViewModel : BaseListViewModel<Outgo>
    {
        public OutgoListViewModel(OutgoRepository repository, SearchBaseDto searchModel, IObservable<Func<Outgo, bool>> criteria)
            : base(repository, searchModel, criteria, PermissionTypes.Outgoes)
        {
