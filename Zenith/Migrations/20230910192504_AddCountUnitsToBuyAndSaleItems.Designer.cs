...
namespace Zenith.Migrations
{
    ...
    [Migration("20230910192504_AddCountUnitsToBuyAndSaleItems")]
    partial class AddCountUnitsToBuyAndSaleItems
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Zenith.Models.Outgo", b =>
                {
                    ...
                    b.HasDiscriminator<string>("Discriminator").HasValue("Outgo");
            ...
            modelBuilder.Entity("Zenith.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Username = "admin",
                            CreateDateTime = new DateTime(2023, 9, 10, 0, 0, 0, 0, DateTimeKind.Local),
                            HasErrors = false,
            ...
            modelBuilder.Entity("Zenith.Models.MachineOutgo", b =>
                {
                    b.HasBaseType("Zenith.Models.Outgo");
                    ...
                    b.HasDiscriminator().HasValue("MachineOutgo");
                });
