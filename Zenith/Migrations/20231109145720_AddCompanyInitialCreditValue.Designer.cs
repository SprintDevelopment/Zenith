...
namespace Zenith.Migrations
{
    ...
    [Migration("20231109145720_AddCompanyInitialCreditValue")]
    partial class AddCompanyInitialCreditValue
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Zenith.Models.Company", b =>
                {
                    ...
                    b.Property<float>("InitialCreditValue")
                        .HasColumnType("real");
            ...
            modelBuilder.Entity("Zenith.Models.Delivery", b =>
                {
                    ...
                    b.Property<bool>("IsIndirectDelivery")
                        .HasColumnType("bit");

                    b.Property<int>("MachineId")
                        .HasColumnType("int");

                    b.Property<int?>("RelatedTaxiMachineOutgoId")
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime>("SourceDeliveryDateTime")
                        .HasColumnType("datetime2");

                    b.Property<string>("SourceDeliveryNumber")
                        .HasMaxLength(16)
                        .HasColumnType("nvarchar(16)");
            ...
            modelBuilder.Entity("Zenith.Models.Machine", b =>
                {
                    ...
                    b.Property<short?>("OwnerCompanyId")
                        .HasColumnType("smallint");
            ...
            modelBuilder.Entity("Zenith.Models.MachineIncome", b =>
                {
                    ...
                    b.Property<int?>("RelatedOutgoPlusTransportId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Zenith.Models.OutgoCategory", b =>
                {
                    ...
                    b.Property<float>("ApproxUnitPrice")
                        .HasColumnType("real");
            ...
            modelBuilder.Entity("Zenith.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Username = "admin",
                            CreateDateTime = new DateTime(2023, 11, 9, 0, 0, 0, 0, DateTimeKind.Local),
                            HasErrors = false,
            ...
            modelBuilder.Entity("Zenith.Models.Machine", b =>
                {
                    b.HasOne("Zenith.Models.Company", "OwnerCompany")
                        .WithMany()
